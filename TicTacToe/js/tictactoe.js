...
function checkWinConditions(){
    ...
    // X 6, 7, 8 condition.
    else if (arrayIncludes('6X', '7X', '8X')) { drawWinLine(50, 550, 558, 550)}
    // X 0, 3, 6 condition.
    ...
    // X 6, 4, 2 condition.
    else if (arrayIncludes('6X', '4X', '2X')) { drawWinLine(100, 550, 510, 90)}
    // X 0, 4, 8 condition.
    ...
    // O 6, 7, 8 condition.
    else if (arrayIncludes('6O', '7O', '8O')) { drawWinLine(50, 550, 558, 550)}
    // O 0, 3, 6 condition.
    ...
    // O 6, 4, 2 condition.
    else if (arrayIncludes('6O', '4O', '2O')) { drawWinLine(100, 550, 510, 90)}
    // O 0, 4, 8 condition.
