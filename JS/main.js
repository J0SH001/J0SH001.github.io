...
document.addEventListener("click", function(event){
    ...
    if (event.target.matches(".cancel") || !event.target.closest(".form-popup") && !event.target.closest(".Popup") && !event.target.closest(".contact")){
        closeForm()
    }
}, false )// This function displays the first image in the slideshow when the page loads
var slideIndex = 1;
